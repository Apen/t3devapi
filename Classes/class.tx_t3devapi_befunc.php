...
class tx_t3devapi_befunc
{
    ...
    public function renderListNavigation($totalItems, $iLimit, $firstElementNumber, $alwaysShow = false)
    {
        ...
        if ($totalPages > 1 || $alwaysShow == true) {
            ...
            $listURLOrig = \TYPO3\CMS\Core\Utility\GeneralUtility::getIndpEnv('TYPO3_REQUEST_DIR') . 'mod.php?M=' . \TYPO3\CMS\Core\Utility\GeneralUtility::_GP('M');
            $listURL = \TYPO3\CMS\Core\Utility\GeneralUtility::getIndpEnv('TYPO3_REQUEST_DIR') . 'mod.php?M=' . \TYPO3\CMS\Core\Utility\GeneralUtility::_GP('M');
